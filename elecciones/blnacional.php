		...
		<div id="fp-container">
			...
			<div id="fp-body">
				<div id="fp-bcontainer">
					<h3 class="title">
						<span style="float:left">Candidatos a Lista Nacional</span>
					</h3>
				</div>
					...
					<table class="display" cellspacing="0" cellpadding="3" border="0">
						<tbody>
							...
							<?php
								...
								$link = OpenCon();
								$query = "SELECT E.nombres, E.apellidos, C.partido as pp FROM Congreso C, Empadronado E WHERE C.departamento = 0 AND C.dpi = E.dpi ORDER BY C.partido ASC, C.casilla ASC";
								...
								while ($line = pg_fetch_array($result, NULL, PGSQL_ASSOC))
								{
									...
									echo "<input value=\"3\" type=\"number\" min=\"0\" name=\"vopt\" style=\"text-align:center\" required hidden>";
									echo "\t</tr>\n";
								}
