				...
				<div id="fp-bcontainer" class="text-m">
					<table class="display" cellspacing="0" cellpadding="3" border="0">
						<tbody>
							...
							<tr>
								<th id="fp-table3">Departamentos Registrados</th>
								<th id="fp-table2">Registrar Departamento</th>
							</tr>

							<tr>
								<td id="fp-btable2"><img alt="Flag" src="img/folder.png" style="margin-left: 60px; padding-right:5px;" ><a href="lista_dep.php">Departamentos</a></td>
								<td id="fp-btable1"><a href="registro_dep.php"><img alt="gen" src="img/home.gif" style="padding-right:5px;">Registrar</a></td>
							</tr>
