				...
				<div id="fp-bcontainer" class="text-m">
					<table class="display" cellspacing="0" cellpadding="3" border="0">
						<tbody>
							...
							<tr>
								<th id="fp-table3">Mesas Disponibles</th>
								<th id="fp-table2">Registrar Mesa de Votacion</th>
							</tr>

							<tr>
								<td id="fp-btable2"><img alt="Flag" src="img/folder.png" style="margin-left: 60px; padding-right:5px;" ><a href="lista_mes.php">Mesas Registradas</a></td>
								<td id="fp-btable1"><a href="registro_mes.php"><img alt="gen" src="img/reportg.gif" style="padding-right:5px;">Registrar</a></td>
							</tr>
